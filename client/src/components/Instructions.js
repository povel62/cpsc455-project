  ...
  return (
    <div className="Instructions">
      ...
      <p>
        ...
        coat, and breed. With such a dataset, our system is able to find a model
        that most accurately predicts one of the features given all of the other
        ones. In this case, it makes sense to classify the dog&apos;s breed
        given its age, weight, height, length, eye color, and coat. Ensure that
        your CSV includes headers, that any string entry not contain any commas,
      ...
      <p>
        ...
        page that shows a successfully parsed dataset where you can inspect the
        contents one last time before submitting it to our AutoML system.
      </p>
      <p>
        ...
        features. Once again, this would be the dog&apos;s breed in our example.
        Make sure to specify the correct column, as the viewer defaults to the
        first column.
      </p>
      <p>
        ...
        which case you will also be notified via email, but without a prediction
        link.
      </p>
      <p>
        ...
        the breed of 5 new dogs, you need to upload a CSV with 5 rows containing
        each new dog&apos;s age, weight, height, length, eye color, and coat.
        The platform will let you know if your prediction is misformatted.
      </p>
      <p>
